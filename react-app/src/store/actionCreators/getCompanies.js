...
export default function getCompanies(jwt, id, options = {
    orderBy: 'createdAt',
    ordering: 'ASC',
    skip: 0,
    take: 10
    ...
    return dispatch => {
        fetch(`http://localhost:8080/company/${id}/${options.orderBy}/${options.ordering}?skip=${options.skip}&take=${options.take}`, {
            headers: {
